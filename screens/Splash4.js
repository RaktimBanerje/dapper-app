        ...
        <SafeAreaView style={{flex: 1}} forceInset={{top: 'alaways'}}>
            <View style={styles.container}>
                <View style={styles.top}>
                    ...
                    />
                    <Text style={{color: "#263238", fontFamily: 'Poppins_500Medium', fontSize: 28, textAlign: "center", marginVertical: 40}}>Customers who need a haircut can see which barbers are available</Text>
                ...
                <View style={styles.bottom}>
                    ...
                    <Button 
                        ...
                        title={"Next"}
                        onPress={() => navigation.push("Splash5")}
                    />
                </View>
            </View>
        </SafeAreaView>
