        ...
        <SafeAreaView style={{flex: 1}} forceInset={{top: 'alaways'}}>
            <View style={styles.container}>
                <View style={styles.top}>
                    ...
                    />
                    <Text style={{color: "#263238", fontFamily: 'Poppins_500Medium', fontSize: 28, textAlign: "center", marginVertical: 40}}>They are colored coded to show when they are available</Text>
                ...
                <View style={styles.bottom}>
                    ...
                    <Button 
                        ...
                        title={"Next"}
                        onPress={() => navigation.push("Splash9")}
                    />
                </View>
            </View>
        </SafeAreaView>
